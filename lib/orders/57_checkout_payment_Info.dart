...
import 'package:dinewell/Orders/58_checkout_order_placed.dart';
import 'package:dinewell/Widget/buttons.dart';
import 'package:dinewell/Widget/textFields.dart';
import 'package:flutter/material.dart';

class CheckoutPaymentInfo2Screen extends StatefulWidget {
  const CheckoutPaymentInfo2Screen({super.key});

  @override
  State<CheckoutPaymentInfo2Screen> createState() =>
      _CheckoutPaymentInfo2ScreenState();
}

class _CheckoutPaymentInfo2ScreenState
    extends State<CheckoutPaymentInfo2Screen> {

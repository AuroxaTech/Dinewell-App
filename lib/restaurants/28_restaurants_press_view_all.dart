...
import 'package:dinewell/Restaurants/29_home_s_nearby_restaurants_filter.dart';
import 'package:dinewell/Restaurants/33_restaurants_restaurant_coupons.dart';
import 'package:flutter/material.dart';

class RestaurantsPressViewAllScreen extends StatefulWidget {
  const RestaurantsPressViewAllScreen({super.key});

  @override
  State<RestaurantsPressViewAllScreen> createState() =>
      _RestaurantsPressViewAllScreenState();
}

class _RestaurantsPressViewAllScreenState
    extends State<RestaurantsPressViewAllScreen> {
  @override
                        ...
                        InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => nearByRestaurantFilter2Screen(),
                              ),
                            );
                          },
                          child: Image.asset(
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => RestaurantsCouponsScreen(),
          ),
        );
      },
      child: Container(

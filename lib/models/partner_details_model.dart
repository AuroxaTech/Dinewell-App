class PartnerDetailsModel {
  bool? success;
  String? message;
  PartnerDetailsData? data;

  PartnerDetailsModel({this.success, this.message, this.data});

  PartnerDetailsModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    message = json['message'];
    data = json['data'] != null ? new PartnerDetailsData.fromJson(json['data']) : null;
  }
...
class PartnerDetailsData {
  ...
  PartnerDetailsData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class Products {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['name'] = this.name;
    data['description'] = this.description;
    data['point_value'] = this.pointValue;
    data['meta'] = this.meta;
    data['is_active'] = this.isActive;
    data['is_undeletable'] = this.isUndeletable;
    data['is_uneditable'] = this.isUneditable;
